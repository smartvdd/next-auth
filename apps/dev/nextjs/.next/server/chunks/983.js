...
(${e0})(authURL, "${e}");
`;return(0,eQ.tZ)(eQ.HY,{children:(0,eQ.tZ)("script",{dangerouslySetInnerHTML:{__html:t}})})}(c)]})}({csrfToken:e.csrfToken,providers:e.providers?.filter(e=>["email","oauth","oidc"].includes(e.type)||"credentials"===e.type&&e.credentials||"webauthn"===e.type&&e.formFields||!1),callbackUrl:e.callbackUrl,theme:e.theme,error:s,...i}),title:"Sign In",headTags:l})},signout:()=>a?.signOut?{redirect:a.signOut,cookies:n}:e3({cookies:n,theme:r,html:function(e){let{url:t,csrfToken:r,theme:i}=e;return(0,eQ.BX)("div",{className:"signout",children:[i?.brandColor&&(0,eQ.tZ)("style",{dangerouslySetInnerHTML:{__html:`
        :root {
